% \VignetteIndexEntry{ICE Vignette}
...
\author{Robert Scharpf, Giovanni Parmigiani, Jonathan Pevsner, and Ingo Ruczinski}
\maketitle
...
See the documentation pages in the R package \Rpackage{ICE} for more
